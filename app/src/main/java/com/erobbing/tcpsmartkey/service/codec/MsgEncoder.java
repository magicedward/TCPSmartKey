...
import com.erobbing.tcpsmartkey.common.Session;
import com.erobbing.tcpsmartkey.common.TPMSConsts;
import com.erobbing.tcpsmartkey.common.req.TerminalRegisterMsg;
import com.erobbing.tcpsmartkey.common.resp.ServerCommonRespMsgBody;
import com.erobbing.tcpsmartkey.common.resp.TerminalRegisterMsgRespBody;
...
public class MsgEncoder {
    ...
    // public byte[] encode4ServerCommonRespMsg(TerminalAuthenticationMsg req,
    // ServerCommonRespMsgBody respMsgBody, int flowId) throws Exception {
    public byte[] encode4ServerCommonRespMsg(PackageData req, byte[] msgBodyBytes, int flowId)
            throws Exception {
        byte[] msgBody = msgBodyBytes;
